...
proc update_PARAM_VALUE.debug_loopback_mode { PARAM_VALUE.debug_loopback_mode } {
	# Procedure called to update debug_loopback_mode when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.debug_loopback_mode { PARAM_VALUE.debug_loopback_mode } {
	# Procedure called to validate debug_loopback_mode
	return true
}
...
proc update_MODELPARAM_VALUE.debug_loopback_mode { MODELPARAM_VALUE.debug_loopback_mode PARAM_VALUE.debug_loopback_mode } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.debug_loopback_mode}] ${MODELPARAM_VALUE.debug_loopback_mode}
}
