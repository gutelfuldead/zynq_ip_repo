...
proc init_gui { IPINST } {
  ...
  set slot_time_ms [ipgui::add_param $IPINST -name "slot_time_ms"]
  set_property tooltip {duration of each tdma slot in milliseconds} ${slot_time_ms}
  set clk_freq [ipgui::add_param $IPINST -name "clk_freq"]
  set_property tooltip {frequency of input clock} ${clk_freq}
  set pulse_duty [ipgui::add_param $IPINST -name "pulse_duty"]
  set_property tooltip {duty cycle of output slot pulse (% on)} ${pulse_duty}
...
proc update_PARAM_VALUE.pulse_duty { PARAM_VALUE.pulse_duty } {
	# Procedure called to update pulse_duty when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.pulse_duty { PARAM_VALUE.pulse_duty } {
	# Procedure called to validate pulse_duty
	return true
}

proc update_PARAM_VALUE.slot_time_ms { PARAM_VALUE.slot_time_ms } {
	# Procedure called to update slot_time_ms when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.slot_time_ms { PARAM_VALUE.slot_time_ms } {
	# Procedure called to validate slot_time_ms
	return true
}
...
proc update_MODELPARAM_VALUE.slot_time_ms { MODELPARAM_VALUE.slot_time_ms PARAM_VALUE.slot_time_ms } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.slot_time_ms}] ${MODELPARAM_VALUE.slot_time_ms}
}
...
proc update_MODELPARAM_VALUE.pulse_duty { MODELPARAM_VALUE.pulse_duty PARAM_VALUE.pulse_duty } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.pulse_duty}] ${MODELPARAM_VALUE.pulse_duty}
}
