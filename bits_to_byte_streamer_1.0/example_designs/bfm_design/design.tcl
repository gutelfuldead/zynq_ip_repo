proc create_ipi_design { offsetfile design_name } {
	...
	set bits_to_byte_streamer_0 [ create_bd_cell -type ip -vlnv spacemicro.com:user:bits_to_byte_streamer:1.0 bits_to_byte_streamer_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores spacemicro.com:user:bits_to_byte_streamer:1.0]]]]
