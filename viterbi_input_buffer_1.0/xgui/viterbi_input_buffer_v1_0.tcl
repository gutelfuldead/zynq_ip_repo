...
proc init_gui { IPINST } {
  ...
  set_property tooltip {Number of zeros used to prime and maintain the Viterbi Decoder} ${TAIL_SIZE}
  set BLOCK_SIZE [ipgui::add_param $IPINST -name "BLOCK_SIZE"]
  set_property tooltip {Number of valid symbols in the block} ${BLOCK_SIZE}
